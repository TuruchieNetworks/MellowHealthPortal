...
<body class="container-fluid p-8" style="
    ...
    <table class="table table-dark text-center" style="border-radius: 5%;">
		...
		<div class="btn btn-primary" style="display:flex;flex-wrap:wrap;justify-content:space-between;align-items:space-between;text-align:center;background:rgba(1.33, 0.64, 30.60, 0.9);border-radius:7%;padding:5px;margin:5px 0;width:100%;">
		    <form action="/mellowHealth/patientAddresses/${onePatientAddress.id}" class="btn btn-outline-primary" style="display:flex;flex-wrap:wrap;justify-content:space-between;align-items:center;text-align:center; padding:5px;background:rgba(1.33, 0.64, 30.60, 0.9);border-radius:7%;margin:5px;width:100%;">
        ...
        <div class="column-card">
    		<div class="inner-column-card">
	        	<p class="btn btn-outline-success"  style="margin:10px;">
	        		<c:out value="Address ID: ${onePatientAddress.id}"/>
			        <a class="inner-column-card" href="/mellowHealth/patientsPortal/patients/${onePatientAddress.patient.id}"  style="text-decoration:none; 
		         	<c:choose>
	            	...
	            	<c:out value="${onePatientAddress.patient.patientFirstName} ${onePatientAddress.patient.patientLastName}: Mellow Patient Since ${onePatientCreatedAt}"/>
	            	<div class="column-card btn btn-outline-primary" style="display:flex;flex-wrap:wrap;justify-content:center;align-items:center;text-align:center;margin:5px 0; padding:10px;background:rgba(1.33, 0.64, 0.60, 0.9);">
			            <c:out value="Street Name: ${onePatientAddress.street}"/>
		           		<div class="inner-column-card btn btn-outline-primary" style="display:flex;justify-content:space-between;align-items:center;text-align:center;margin:5px; padding:10px;background:rgba(1.33, 10.64, 0.60, 0.9);">
			            	<c:out value="City Info: ${onePatientAddress.city}"/>
			            	<c:out value="${onePatientAddress.state} ${onePatientAddress.zipCode}"/>
			            	<c:out value="Date Of Birth: ${onePatientAddress.patient.dateOfBirth}"/>
			            </div>
			            <p>
			            	<c:out value="Contact Details: ${onePatientAddress.phoneNumber}"/>
			            	<c:out value="Email Address: ${onePatientAddress.patient.email}"/>
				...
				<div class="btn btn-outline-success column-card" style="padding:10px;">
					<div class="btn btn-outline-success inner-generic-display-container" style="padding:10px;background:rgba(1.33, 0.64, 0.60, 0.9);background:rgba(13.33, 0.64, 0.60, 0.9);">
	        			<form action="/mellowHealth/patientsPortal/patients/${onePatientAddress.patient.id}" method="get" style="margin:5px;width:100%;">
			    		...
			    		<form action="/mellowHealth/patientAddresses/editPatientAddress/${onePatientAddress.id}" method="get" style="margin:5px;width:100%;">
	        			...
	        			<form action="/mellowHealth/patientAddresses/deletePatientAddress/${onePatientAddress.id}" method="post" style="margin:5px;width:100%;">
