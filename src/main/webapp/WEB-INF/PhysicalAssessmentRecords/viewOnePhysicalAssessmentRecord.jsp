	...
	<table class="table table-dark" style="text-align:center;border-radius:5%;">
		...
		<tbody>
		            <tr style="text-decoration:none; color:aqua"class="table-dark">
		                <td><c:out value="${onePhysicalAssessment.id}" /></td>
		                <td>
				        ...
				        <td style=" 	
			        		<c:choose>
				             ...
				             " class="d-flex justify-content-around">
								<form action="/mellowHealth/diagnosis/physicalAssessments/editPhysicalAssessment/${onePhysicalAssessment.id}" method="get" style="margin:0 10px 0 0; ">
								...
								<form action="/mellowHealth/diagnosis/physicalAssessments/deletePhysicalAssessment/${onePhysicalAssessment.id}" method="post">
