   	...
   	<c:choose>
		...
		<c:otherwise>
			...
			<div class ="btn btn-primary"  style="width:100%;display:flex;flex-wrap:wrap;justify-content:space-between;align-items:center;text-align:center; background:rgba(1.33, 0.64, 30.60, 0.9);border-radius:7%;padding:5px;">
				<form action="/mellowHealth/followUpRecords/newFollowUpRecord" class ="btn btn-primary"  style="width:100%;display:flex;flex-wrap:wrap;justify-content:space-between;align-items:center;text-align:center; padding:5px;background:rgba(1.33, 0.64, 30.60, 0.9);border-radius:7%;">
		...
		<div class="row">
			...
			<div class="col">
				<form:form action="/mellowHealth/process/followUpRecords/createNewFollowUpRecord" method="POST" modelAttribute="followUpRecord">
				...
				<!--form:errors path="*" cssClass="text-danger"/!-->
					...
					<input type="submit" value="Add New Follow Up Record Today ${currentDateTime}" class="btn btn-success" style="margin: 10px 0; width: 100%; padding: 10px;"/>
				</form:form>
