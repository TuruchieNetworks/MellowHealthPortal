...
<body class="container-fluid p-8" style="
    ...
    <table class="table table-dark text-center" style="border-radius: 5%;">
		...
		<div class="btn btn-primary" style="display:flex;flex-wrap:wrap;justify-content:space-between;align-items:space-between;text-align:center;background:rgba(1.33, 0.64, 30.60, 0.9);border-radius:7%;padding:5px;margin:5px 0;width:100%;">
		    <form action="/mellowHealth/coagulationRecords/${oneCoagulationRecord.id}" class="btn btn-outline-primary" style="display:flex;flex-wrap:wrap;justify-content:space-between;align-items:center;text-align:center; padding:5px;background:rgba(1.33, 0.64, 30.60, 0.9);border-radius:7%;margin:5px;width:100%;">
		...
		<c:forEach items="${oneSearchedSingleCoagulationRecordsList}" var="searchedCoagulation">
        <div class="column-card">
    		<div class="inner-column-card">
	        	<p class="btn btn-outline-success"  style="background:rgba(1, 20.31, 1, 0.9);border-radius:5%;">
		...
		<div class="btn btn-primary" style="display:flex;flex-wrap:wrap;justify-content:space-between;align-items:space-between;text-align:center;background:rgba(1.33, 0.64, 30.60, 0.9);border-radius:7%;padding:5px;margin:5px 0;width:100%;">
			...
			<c:if test="${not empty searchedPatientCasesList}">
			    <p class="btn btn-outline-primary form-control" style="color:rgba(311, 31, 321, 0.9);background:rgba(11, 0.31, 1, 0.9);">
		   		  	<a class="btn btn-outline-primary" href="/mellowHealth/hospitalDashboard/patientCases/${oneSearchedSinglePatientCasesList[0].id}" style="text-decoration:none;">
					    <c:out value="${oneSearchedSinglePatientCasesList[0].patient.patientFirstName} ${oneSearchedSinglePatientCasesList[0].patient.patientLastName} Date Of Birth: ${oneSearchedSinglePatientCasesList[0].patient.dateOfBirth}"/>
					</a>
			    </p>
			</c:if>
		...
		<c:forEach items="${searchedPatientCasesList}" var="patientCase">
			        ...
			        <div class="inner-generic-tab btn btn-outline-warning" style="">
			    		...
			    		<c:choose>
							...
							<div class="btn btn-primary" style="display:flex;flex-wrap:wrap;justify-content:space-between;align-items:space-between;text-align:center;background:rgba(1.33, 0.64, 30.60, 0.9);border-radius:7%;padding:5px;margin:5px 0;width:100%;">
								...
								<c:if test="${not empty searchedPatientCasesList}">
								    <p class="btn btn-outline-primary form-control" style="color:rgba(311, 31, 321, 0.9);background:rgba(11, 0.31, 1, 0.9);">
							   		  	<a class="btn btn-outline-primary" href="/mellowHealth/hospitalDashboard/patientCases/${oneSearchedSinglePatientCasesList[0].patient.id}" style="text-decoration:none;">
										    <c:out value="${oneSearchedSinglePatientCasesList[0].patient.patientFirstName} ${oneSearchedSinglePatientCasesList[0].patient.patientLastName} Date Of Birth: ${oneSearchedSinglePatientCasesList[0].patient.dateOfBirth}"/>
										</a>
								    </p>
								</c:if>
