...
<body class="container-fluid p-8" style="
	...
	<div class="container-fluid p-6" style=" text-align:center;">
		...
		<div class="row">
			...
			<div class="col">
				<form:form action="/mellowHealth/process/insuranceRecords/createNewInsuranceRecord" method="POST" modelAttribute="insuranceInformation">
				...
				<!--form:errors path="*" cssClass="text-danger"/!-->
			       <div class="form-group">
					...
					<div class="form-group">
					    ...
					    <form:input type="date" path="startDate" class="form-control" placeholder="Please Enter Start Date!" style="width:100%; padding:8px; border-radius:5%;" />
					</div>
					...
					<div class="form-group">
					    ...
					    <form:input type="date" path="expirationDate" class="form-control" placeholder="Please Enter Systolic BloodPressure Value!" style="width:100%; padding:8px; border-radius:5%;" />
					</div>
