...
public class CurrentMedication {
	...
	@Size(min = 3, max = 125, message = "Dosage Amount Must Be Between 3 and 150 Characterss")
    ...
    @NotNull(message = "Please Enter Hourly Frequency Information!")
    ...
    @NotBlank(message = "Please Enter Regimen!")
